...
export const experiences: experienceType[] = [
  ...
  {
    id: "exp2",
    companies: "California State Fullerton",
  ...
  },
  {
    ...
    link: "https://www.goldenwestcollege.edu/asc/index.html",
    description: [
      "💙 Setting up lecture and review for problem solving for each questions \n Organize study session and exam review for students to come to ask if there's any questions about the professor's lecture, then go over the lecture one more time.",
      "💙 Organize office hours that students can join and ask anything related to the course's materials",
    ],
  },
];
